...
担当者はクライアント ブックを使用して主要顧客を追跡し、誕生日、記念日、好き嫌いなどの追加情報を取得できます。 小売業者は、取り込まれた情報を、顧客を管理する販売担当者だけが利用できるようにするか、またはすべての担当者が利用できるようにするかを構成できます。 さらに、小売業者が Dynamics 365 Customer Insights を使用している場合、小売業者は販売時点管理 (POS) に表示する分析情報を選択できます。 販売担当者は、顧客プロファイルのメモやアクティビティを作成することもできます。
<!--feature detail end -->
...
[クライアンテリングの概要](https://docs.microsoft.com/dynamics365/retail/clienteling-overview) (ドキュメント)
