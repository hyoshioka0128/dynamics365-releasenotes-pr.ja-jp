...
## <a name="costing"></a>原価計算
 ...
 | 機能    | 有効対象    |  パブリック プレビュー | 一般提供 |
 | ---------- | ---------- | :----------: |:----------: |
 | [品目価格の比較の格納](compare-item-price-storage.md) | エンド ユーザー、管理者/作成者/アナリストによる有効化  | ![この機能はリリース済みです。](/dynamics365-release-plan/media/green-checkmark.png "この機能はリリース済みです。") 2020 年 2 月 1 日|2020 年 4 月 | 
 | [複数の在庫資産の表現 (プレビュー)](multiple-inventory-asset-representations-preview.md) | エンド ユーザー、管理者/作成者/アナリストによる有効化  | 2020 年 5 月|2020 年 7 月 | 
