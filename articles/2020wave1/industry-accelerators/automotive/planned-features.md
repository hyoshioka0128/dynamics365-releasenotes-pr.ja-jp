...
---
# <a name="whats-new-and-planned-for-automotive"></a>自動車向けの新機能と予定されている機能
...
| ---------- |---------------- | :---------------: |:--------------: |
| [Automotive Accelerator](automotive-accelerator.md) | エンド ユーザー、管理者/作成者/アナリストによる有効化| -|![この機能はリリース済みです。](/dynamics365-release-plan/media/green-checkmark.png "この機能はリリース済みです。") 2020 年 5 月 27 日 | 
