...
---
# <a name="whats-new-and-planned-for-manufacturing"></a>製造業向けの新機能と予定されている機能
...
| ---------- |---------------- | :---------------: |:--------------: |
 | [Manufacturing Accelerator](manufacturing-accelerator.md) | エンド ユーザー、管理者/作成者/アナリストによる有効化 | ![この機能はリリース済みです。](/dynamics365-release-plan/media/green-checkmark.png "この機能はリリース済みです。") 2020 年 5 月 7 日|2020 年 7 月 | 
