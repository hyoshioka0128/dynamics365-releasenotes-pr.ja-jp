...
---
# <a name="whats-new-and-planned-for-dynamics-365-nonprofit-accelerator"></a>Dynamics 365 Nonprofit Accelerator の新機能と予定されている機能
...
| ---------- |---------------- | :---------------: |:--------------: |
| [Nonprofit Accelerator](nonprofit-accelerator.md) | エンド ユーザー、管理者/作成者/アナリストによる有効化| -|![この機能はリリース済みです。](/dynamics365-release-plan/media/green-checkmark.png "この機能はリリース済みです。") 2020 年 6 月 3 日 | 
