...
---
# <a name="whats-new-and-planned-for-media-and-communications"></a>Media and Communications の新機能と予定されている機能
...
| ---------- |---------------- | :---------------: |:--------------: |
| [Media and Communications Accelerator](media-communications-accelerator.md) | エンド ユーザー、管理者/作成者/アナリストによる有効化| ![この機能はリリース済みです。](/dynamics365-release-plan/media/green-checkmark.png "この機能はリリース済みです。") 2020 年 5 月 11 日|2020 年 7 月 | 
