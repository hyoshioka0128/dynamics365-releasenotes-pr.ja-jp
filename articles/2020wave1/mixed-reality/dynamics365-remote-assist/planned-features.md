...
| ---------- |---------------- | :---------------: |:--------------: |
| [空間マークアップを介して資産の状態をキャプチャする](capture-asset-condition-through-spatial-markup.md) | エンド ユーザー、管理者/作成者/アナリストによる有効化| ![この機能はリリース済みです。](/dynamics365-release-plan/media/green-checkmark.png "この機能はリリース済みです。") 2020 年 6 月 10 日|- | 
